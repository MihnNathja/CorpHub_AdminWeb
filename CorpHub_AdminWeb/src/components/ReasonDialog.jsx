...
export default function ReasonDialog({
  ...
  onAction,
  isAcceptDialog = true,
  title = isAcceptDialog ? "Approval confirmation" : "Rejection confirmation",
}) {
        ...
        <>
          ...
          >
            ...
            >
              ...
              <div
                className={`relative bg-gradient-to-r ${config.gradient} px-6 py-5 text-white`}
              >
                <motion.div
                  animate={{
                    scale: [1, 1.2, 1],
              ...
              <div className="p-6">
                ...
                {!isAcceptDialog && (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <AlertCircle
                        className={`w-5 h-5 text-${config.color}-600 dark:text-${config.color}-400 flex-shrink-0 mt-0.5`}
                      />
                      <div>
                        <p
                          className={`text-sm font-semibold text-${config.color}-800 dark:text-${config.color}-300`}
                        >
                          Reason required
                        </p>
                        <p
                          className={`text-xs text-${config.color}-700 dark:text-${config.color}-400 mt-1`}
                        >
                          Please provide a clear reason so the requester
                ...
                <div>
                  <label className="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                    ...
                    {isAcceptDialog ? "Note (optional)" : "Rejection reason"}
