...
const TicketsPage = () => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 rounded-xl shadow-inner p-6">
      <h2 className="text-xl font-bold mb-4 text-gray-800 dark:text-gray-100">Tickets Management</h2>
      ...
      <div className="flex border-b border-gray-200 dark:border-gray-700">
        {tabs.map((tab) => (
          <button
            ...
            className={`px-4 py-2 -mb-px font-medium rounded-t-lg transition-colors ${activeTab === tab.key
