                ...
                <div className="flex items-center gap-2">
                    ...
                    {item.currentApproverId === currentUserId &&
                        item.workflowStatus === "IN_PROGRESS" && (
                            <>
                                <IconButton color="green" onClick={() => approveRequest(item.workflowInstanceId, "Đồng ý")}>
                                    <CheckCircleIcon className="w-5 h-5" />
                                </IconButton>

                                <IconButton color="red" onClick={() => rejectRequest(item.workflowInstanceId, "Không hợp lệ")}>
